"""
Agentic RAG Implementation with LangChain and Groq's API
...
class AgenticRAGConfig:
    ...
    collection_name: str = "instrument_knowledge"
...
class AgenticRAGSystem:
    ...
    def __init__(self, config: AgenticRAGConfig = None, groq_api_key: str = None, tavily_api_key: str = None, HF_token: str = None):
        """
