...
def initialize_rag_system_sync(config, groq_api_key, tavily_api_key):
...
def main():
    ...
    # Header
    st.header("🤖 Agentic RAG System for RSSA Field instruments")
    st.markdown("---")
    ...
    with st.sidebar:
        ...
        llm_model = st.selectbox(
            "LLM Model",
            ["openai/gpt-oss-120b", "qwen/qwen3-32b","groq/compound", "llama-3.1-8b-instant", "moonshotai/kimi-k2-instruct"],
            help="Choose the model for reasoning"
        )
    ...
    with tab1:
        st.subheader("💬 Ask a Question about Field instruments")
        ...
        if not system_ready:
            ...
            user_query = st.text_area(
                "Enter your question:",
                height=100,
                placeholder="Ask anything about the RSSA field instruments!"
            )
