...
![Groq LLM](https://img.shields.io/badge/Ggroq-LLM-00bfa5)
...
- **Groq LLM API (Free tier)**: Groq's AI models 
...
### 📋 Installation & Running App
   ...
   2. Clone the repository:
      ...
      ```bash
      git clone https://github.com/prashanthreddy31/Agentic-RAG-application
   ...
   6. Configure environment — **never commit the `.env` file to version control**:
      ...
      * Add your API keys:
        ...
        ```bash
        GROQ_API_KEY=your_key_here   # Required — free tier
...
1. **Groq API Key Error**
   ...
   ```
   **Solution**: Ensure your Groq API key is properly set in the `.env` file
